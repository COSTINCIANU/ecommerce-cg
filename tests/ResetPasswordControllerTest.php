...
class ResetPasswordControllerTest extends WebTestCase
{
    ...
    //     // self::assertEmailAddressContains($messages[0], 'from', 'gheorghina.costincianu@sfr.fr');
    //     self::assertEmailAddressContains($messages[0], 'from', 'costincianu.gheorghina@gmail.com');
    ...
    public function testResetPasswordController(): void
    {
        $this->markTestSkipped('Test ignoré : le transport null://null ne supporte pas assertQueuedEmailCount. À tester avec un vrai transport SMTP.');
    }
}
