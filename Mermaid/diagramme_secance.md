...
<!-- Ajout au panier -->
```mermaid
%%{init: { "theme": "base", "sequence": { "wrap": true, "showSequenceNumbers": false, "messageAlign": "left", "useMaxWidth": true, "rightAngles": true } } }%%
sequenceDiagram
    actor Client
    participant Browser
...
flowchart TD
    ...
    style A fill:#84cc16,stroke:#1f2937,stroke-width:2px,color:#111827
    style B fill:#60a5fa,stroke:#1f2937,stroke-width:1px,color:#111827
    style C fill:#facc15,stroke:#1f2937,stroke-width:1px,color:#111827
    style D fill:#34d399,stroke:#1f2937,stroke-width:1px,color:#111827
    style E fill:#ef4444,stroke:#1f2937,color:#ffffff,stroke-width:1px
    style F fill:#facc15,stroke:#1f2937,stroke-width:1px,color:#111827
    style G fill:#60a5fa,stroke:#1f2937,stroke-width:1px,color:#111827
    style H fill:#ef4444,stroke:#1f2937,color:#ffffff,stroke-width:1px
    style I fill:#60a5fa,stroke:#1f2937,stroke-width:1px,color:#111827
    style J fill:#60a5fa,stroke:#1f2937,stroke-width:1px,color:#111827
    style K fill:#facc15,stroke:#1f2937,stroke-width:1px,color:#111827
    style L fill:#34d399,stroke:#1f2937,stroke-width:1px,color:#111827
    style M fill:#facc15,stroke:#1f2937,stroke-width:1px,color:#111827
    style N fill:#22c55e,stroke:#1f2937,stroke-width:1px,color:#111827
    style O fill:#ef4444,stroke:#1f2937,color:#ffffff,stroke-width:1px
    style P fill:#16a34a,stroke:#1f2937,stroke-width:2px,color:#ffffff
...
```mermaid
%%{init: { "theme": "base", "sequence": { "wrap": true, "showSequenceNumbers": true, "messageAlign": "left", "useMaxWidth": true, "rightAngles": true } } }%%
sequenceDiagram
    autonumber
    actor Client
    participant Browser
